...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( SessionModel session,  AccessRights accessRights)?  authenticated,TResult Function()?  unauthenticated,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthStateInitial() when initial != null:
return initial();case AuthStateLoading() when loading != null:
return loading();case AuthStateAuthenticated() when authenticated != null:
return authenticated(_that.session,_that.accessRights);case AuthStateUnauthenticated() when unauthenticated != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( SessionModel session,  AccessRights accessRights)  authenticated,required TResult Function()  unauthenticated,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case AuthStateInitial():
return initial();case AuthStateLoading():
return loading();case AuthStateAuthenticated():
return authenticated(_that.session,_that.accessRights);case AuthStateUnauthenticated():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( SessionModel session,  AccessRights accessRights)?  authenticated,TResult? Function()?  unauthenticated,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case AuthStateInitial() when initial != null:
return initial();case AuthStateLoading() when loading != null:
return loading();case AuthStateAuthenticated() when authenticated != null:
...
class AuthStateAuthenticated implements AuthState {
  const AuthStateAuthenticated({required this.session, required this.accessRights});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthStateAuthenticated&&(identical(other.session, session) || other.session == session)&&(identical(other.accessRights, accessRights) || other.accessRights == accessRights));
}


@override
int get hashCode => Object.hash(runtimeType,session,accessRights);

@override
String toString() {
  return 'AuthState.authenticated(session: $session, accessRights: $accessRights)';
}
...
@useResult
$Res call({
 SessionModel session, AccessRights accessRights
});


$SessionModelCopyWith<$Res> get session;$AccessRightsCopyWith<$Res> get accessRights;
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? session = null,Object? accessRights = null,}) {
  return _then(AuthStateAuthenticated(
session: null == session ? _self.session : session // ignore: cast_nullable_to_non_nullable
as SessionModel,accessRights: null == accessRights ? _self.accessRights : accessRights // ignore: cast_nullable_to_non_nullable
as AccessRights,
  ));
}
...
@override
@pragma('vm:prefer-inline')
$AccessRightsCopyWith<$Res> get accessRights {
  
  return $AccessRightsCopyWith<$Res>(_self.accessRights, (value) {
    return _then(_self.copyWith(accessRights: value));
  });
}
}
